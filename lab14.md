...
*注：由于我的ubuntu有些卡，本篇主要是在macOS Mojave环境下编译，vim和gcc的操作与Ubuntu大致相同。*
...
>你知道为什么一行代码要控制在80（字符）列以内？ 原因是 … 原来历史上读程序的卡片机只能读80个字符。当然，超过 80 个字符也打不出来阅读了。<br><br>
...
sin-demo.c 的代码。（这里仅是转抄，方便你复制）<br>
